...
export const experiences = [
  {
    ...
    tech: ["GitHub Actions", "Docker", "Docker Compose", "Git", "SonarQube", "Linux", "MERN"],
    points: [
      "Implemented CI/CD workflows using GitHub Actions, Git, and Docker to automate application build and deployment processes.",
      "Containerized and deployed MERN applications using Docker and Docker Compose while troubleshooting environment and deployment issues across development workflows.",
      "Performed SonarQube code-quality analysis and optimization while collaborating with development teams to improve code quality and maintainability.",
      "Supported DevOps and deployment workflows, including application configuration, Git-based collaboration, and troubleshooting containerized applications.",
    ],
  },
];
...
export const projects = [
  {
    title: "EstateHub — Cloud-Native DevOps Deployment Platform",
    category: "Cloud-Native DevOps",
    summary:
      "Deployed a containerized MERN application on AWS EKS using Kubernetes, Helm, Docker, and AWS LoadBalancer with health probes and autoscaling.",
    impact:
      "Implemented GitHub Actions CI/CD with AWS OIDC, automating Docker image builds, Docker Hub publishing, Helm-based deployments, rolling updates, and verification.",
    stack: ["AWS EKS", "Kubernetes", "Docker", "Helm", "GitHub Actions", "Docker Hub", "AWS IAM/OIDC"],
    featured: true,
    workflow: ["Code", "GitHub Actions", "Docker", "Docker Hub", "Helm", "AWS EKS"],
  },
  {
    title: "TalkTime — Cloud-Native Real-Time Chat DevOps Platform",
    category: "Cloud-Native DevOps",
    summary:
      "Deployed a containerized real-time MERN/Socket.IO chat application on AWS EKS using Docker, Kubernetes, and Helm.",
    impact:
      "Implemented CI/CD and GitOps with GitHub Actions and Argo CD, automating builds, Docker Hub publishing, and EKS deployment.",
    stack: ["AWS EKS", "Kubernetes", "Docker", "Helm", "GitHub Actions", "Argo CD", "AWS ALB", "Redis", "S3"],
    featured: true,
    workflow: ["Code", "GitHub Actions", "Docker", "Docker Hub", "Argo CD", "AWS EKS"],
  },
  {
  ...
  },
  {
    ...
    summary:
      "Developed reusable Terraform configurations to provision AWS infrastructure and automate container deployments.",
    impact:
      "Created Linux automation scripts and Kubernetes manifests to standardize environments and reduce manual infrastructure setup.",
    stack: ["Terraform", "AWS", "Docker", "Kubernetes", "Linux"],
  },
  {
    title: "Telecom Customer Churn Prediction Platform on AWS",
    category: "Machine Learning / Cloud",
    summary:
      "Deployed a Dockerized ML platform on AWS EC2 to analyze 243,000+ telecom records and predict churn using Python and Scikit-learn.",
    impact:
      "Used S3, IAM, CloudWatch, and GitHub Actions for storage, access management, monitoring, and CI/CD.",
    stack: ["AWS EC2", "S3", "IAM", "CloudWatch", "Docker", "GitHub Actions", "Python", "Scikit-learn", "SQL", "React.js"],
  },
  {
